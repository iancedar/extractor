    ...
    if (selectedLengthFilter !== "all") {
      filtered = filtered.filter(keyword => {
        ...
        switch (selectedLengthFilter) {
          case "short": return wordCount <= 3;
          case "medium": return wordCount >= 4 && wordCount <= 8;
          case "long": return wordCount > 8;
          default: return true;
        }
      });
    }
          ...
          <div data-testid="keywords-display">
            ...
            <div className="mb-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-4">
              <div className="text-center">
                ...
                <div className="text-sm text-slate-600">Total Keywords Extracted</div>
              </div>
            ...
            <div className="bg-slate-50 rounded-lg p-4 mt-6">
              <h4 className="text-sm font-semibold text-slate-700 mb-3">Keyword Distribution</h4>
